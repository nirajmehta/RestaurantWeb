    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(Customer user)
        {
            ...
            using (var db = new AppDbContext())
            {
                ...
                {
                    user.Role = Roles.Customer.ToString(); //default role
        ...
        public ActionResult Login()
        {
            ...
            {
                TempData["ReturnUrl"] = Request.QueryString["ret"];
            }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Login(Customer user, string returnUrl)
        {
            using (var db = new AppDbContext())
            {
