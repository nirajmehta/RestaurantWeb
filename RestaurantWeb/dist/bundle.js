...
class AppRouter extends React.Component {
    render() {
        return (React.createElement("div", null,
            React.createElement(react_router_1.Route, { exact: true, path: '/', component: MenuBox_1.MenuBox })));
    }
}
...
class MenuBox extends React.Component {
    ...
    render() {
        ...
        var totalAndContinueLink = React.createElement("div", { className: "grandTotal cartEmpty" }, "Your Cart is Empty!");
        if (total > 0)
        ...
        return (React.createElement("div", { className: 'popup' },
            React.createElement("div", { className: 'popup_inner' },
                React.createElement("div", { style: { height: '35px', fontSize: '18' } },
                    React.createElement("b", null, "Order from Niraj's Eatery"),
                    React.createElement("hr", null)),
...
const AppRouter_1 = __webpack_require__(/*! ./AppRouter */ "./Content/src/AppRouter.tsx");
const rootElement = document.getElementById('foodorder');
ReactDOM.render(React.createElement(react_router_dom_1.BrowserRouter, { basename: "/" },
    React.createElement(AppRouter_1.AppRouter, null)), rootElement);
